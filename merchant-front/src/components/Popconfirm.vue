  ...
  <span class="relative inline-block align-middle" ref="triggerRef">
    ...
    >
      <div
        ...
        ref="popoverRef"
        :class="[
          'absolute z-50 w-64 rounded-xl bg-white shadow-xl border border-slate-200/80 p-4',
          positionClass,
        ]"
        @click.stop
      >
        ...
        <div class="flex items-center justify-end gap-2">
          ...
          <button
            @click="confirm"
            class="px-3 py-1.5 text-xs font-label-bold rounded-lg text-white transition-colors"
