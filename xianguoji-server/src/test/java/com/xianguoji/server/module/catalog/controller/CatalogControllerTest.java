...
class CatalogControllerTest extends AbstractApiTest {
    ...
    class RecordSearchTests {
        ...
        @Test
        @DisplayName("TC-API-CAT-SH-004: Should record search keyword")
        void recordSearch_shouldRecordKeyword_success() throws Exception {
            // Arrange
            String token = "test_token";
        ...
        @Test
        @DisplayName("TC-API-CAT-SH-004: Should not record empty keyword")
