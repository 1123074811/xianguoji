...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='商家端通知';
...
INSERT INTO `group_buy_activity` VALUES (1,3,6,29.90,3,24,'2026-05-01 00:00:00','2026-06-30 23:59:59',46,12,1,'2026-05-04 16:03:17','2026-05-04 16:03:17'),(2,1,65,26.01,2,48,'2026-05-09 12:26:16','2026-06-30 23:59:00',80,30,1,'2026-05-04 16:03:17','2026-05-09 12:26:16'),(3,4,8,16.90,3,24,'2026-05-01 00:00:00','2026-06-30 23:59:59',36,10,1,'2026-05-04 16:03:17','2026-05-04 16:03:17'),(4,20,35,49.90,5,24,'2026-04-01 00:00:00','2026-04-30 23:59:59',50,8,0,'2026-05-04 16:03:17','2026-05-04 16:03:17'),(5,24,56,153.00,3,24,'2026-05-07 22:54:54','2026-05-08 22:54:00',3,0,0,'2026-05-07 22:54:54','2026-05-09 10:20:00');
...
INSERT INTO `group_buy_instance` VALUES (1,1,2,3,3,2,'2026-04-25 10:00:00','2026-04-25 10:30:00',NULL,'2026-04-25 08:00:00','2026-05-04 16:03:17',NULL,NULL),(2,2,1,1,2,3,'2026-05-02 10:00:00',NULL,NULL,'2026-05-01 10:00:00','2026-05-04 16:03:17',NULL,NULL),(3,3,2,2,3,3,'2026-05-02 14:00:00',NULL,NULL,'2026-05-01 14:00:00','2026-05-04 16:03:17',NULL,NULL),(4,1,3,1,3,3,'2026-05-07 19:23:07',NULL,'YBVJU858','2026-05-06 19:23:07','2026-05-07 19:25:00',3,3),(5,5,3,1,3,3,'2026-05-08 23:08:46',NULL,'WHYBNH5L','2026-05-07 23:08:46','2026-05-09 10:05:00',3,3),(6,5,3,1,3,3,'2026-05-08 23:22:22',NULL,'SSXLGART','2026-05-07 23:22:22','2026-05-09 10:05:00',3,3),(7,5,3,1,3,1,'2026-05-09 12:35:08',NULL,'SCZTA9LP','2026-05-08 12:35:08','2026-05-08 12:35:08',3,3);
...
CREATE TABLE `order_status_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_order_id` (`order_id`)
) ENGINE=InnoDB AUTO_INCREMENT=58 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='订单状态流转日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=124 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='商品图片';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `product_sku` (
  ...
  KEY `idx_product_id` (`product_id`)
) ENGINE=InnoDB AUTO_INCREMENT=68 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='商品规格 SKU';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-05-09 12:29:17
