...
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='商家端通知';
...
INSERT INTO `admin_notification` VALUES (1,1,'催单提醒','用户催促发货，订单 260506160721755369','/orders',1,'2026-05-06 18:42:37'),(2,1,'新订单待处理','您有新的订单 260506184333196974，金额 ¥54.90，配送方式：配送','/orders',1,'2026-05-06 18:43:34'),(3,4,'新拼团开团','「丹东99草莓」拼团已开团（1/3）','/campaign',1,'2026-05-06 19:23:07'),(4,4,'拼团失败','「丹东99草莓」拼团失败，已自动取消订单','/campaign',1,'2026-05-07 19:25:00'),(5,4,'新拼团开团','「hhh」拼团已开团（1/3）','/campaign',1,'2026-05-07 23:08:47'),(6,4,'新拼团开团','「hhh」拼团已开团（1/3）','/campaign',1,'2026-05-07 23:22:22'),(7,4,'新拼团开团','「hhh」拼团已开团（1/3）','/campaign',1,'2026-05-08 12:35:08'),(8,4,'拼团失败','「hhh」拼团失败，已自动取消订单','/campaign',1,'2026-05-09 10:05:00'),(9,4,'拼团失败','「hhh」拼团失败，已自动取消订单','/campaign',1,'2026-05-09 10:05:00'),(10,4,'拼团活动已到期','「hhh」拼团活动已到期自动关闭，进行中的团不受影响','/campaign',1,'2026-05-09 10:20:00'),(11,4,'拼团失败','「#5」拼团失败，已自动取消订单','/campaign',0,'2026-05-09 12:40:00');
...
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='购物车';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `cart_item` VALUES (1,1,1,1,2,1,'2026-05-04 16:03:17','2026-05-04 16:03:17'),(2,1,3,6,1,1,'2026-05-04 16:03:17','2026-05-04 16:03:17'),(3,1,5,10,1,1,'2026-05-04 16:03:17','2026-05-04 16:03:17'),(4,1,4,8,1,0,'2026-05-04 16:03:17','2026-05-04 16:03:17'),(5,1,20,35,1,0,'2026-05-04 16:03:17','2026-05-04 16:03:17'),(16,3,4,8,1,1,'2026-05-09 10:25:26','2026-05-09 10:25:26');
...
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='浏览足迹';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `group_buy_activity` VALUES (1,3,6,29.90,3,24,'2026-05-01 00:00:00','2026-06-30 23:59:59',46,12,1,'2026-05-04 16:03:17','2026-05-04 16:03:17'),(2,1,68,26.01,2,48,'2026-05-09 12:37:57','2026-06-30 23:59:00',80,30,1,'2026-05-04 16:03:17','2026-05-09 12:37:57'),(3,4,8,16.90,3,24,'2026-05-01 00:00:00','2026-06-30 23:59:59',36,10,1,'2026-05-04 16:03:17','2026-05-04 16:03:17'),(4,20,35,49.90,5,24,'2026-04-01 00:00:00','2026-04-30 23:59:59',50,8,0,'2026-05-04 16:03:17','2026-05-04 16:03:17'),(5,24,56,153.00,3,24,'2026-05-07 22:54:54','2026-05-08 22:54:00',3,0,0,'2026-05-07 22:54:54','2026-05-09 10:20:00');
...
CREATE TABLE `group_buy_instance` (
  ...
  KEY `idx_status` (`status`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='拼团实例';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `group_buy_instance` VALUES (1,1,2,3,3,2,'2026-04-25 10:00:00','2026-04-25 10:30:00',NULL,'2026-04-25 08:00:00','2026-05-04 16:03:17',NULL,NULL),(2,2,1,1,2,3,'2026-05-02 10:00:00',NULL,NULL,'2026-05-01 10:00:00','2026-05-04 16:03:17',NULL,NULL),(3,3,2,2,3,3,'2026-05-02 14:00:00',NULL,NULL,'2026-05-01 14:00:00','2026-05-04 16:03:17',NULL,NULL),(4,1,3,1,3,3,'2026-05-07 19:23:07',NULL,'YBVJU858','2026-05-06 19:23:07','2026-05-07 19:25:00',3,3),(5,5,3,1,3,3,'2026-05-08 23:08:46',NULL,'WHYBNH5L','2026-05-07 23:08:46','2026-05-09 10:05:00',3,3),(6,5,3,1,3,3,'2026-05-08 23:22:22',NULL,'SSXLGART','2026-05-07 23:22:22','2026-05-09 10:05:00',3,3),(7,5,3,1,3,3,'2026-05-09 12:35:08',NULL,'SCZTA9LP','2026-05-08 12:35:08','2026-05-09 12:40:00',3,3);
...
CREATE TABLE `group_buy_participant` (
  ...
  KEY `idx_user_id` (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='拼团参与者';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `group_buy_participant` VALUES (1,1,2,10,1,'2026-04-25 08:00:00'),(2,1,1,NULL,0,'2026-04-25 09:00:00'),(3,2,1,NULL,1,'2026-05-01 10:00:00'),(4,3,2,NULL,1,'2026-05-01 14:00:00'),(5,3,1,NULL,0,'2026-05-01 15:00:00'),(6,4,3,17,1,'2026-05-06 19:23:07'),(7,5,3,18,1,'2026-05-07 23:08:46'),(8,6,3,19,1,'2026-05-07 23:22:22'),(9,7,3,20,1,'2026-05-08 12:35:08');
...
CREATE TABLE `order_item` (
  ...
  KEY `idx_product_id` (`product_id`)
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='订单商品';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `order_status_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_order_id` (`order_id`)
) ENGINE=InnoDB AUTO_INCREMENT=59 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='订单状态流转日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pickup_point` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_status` (`status`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='自提点';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `pickup_point` VALUES (1,'文三路总店','杭州市西湖区文三路 100 号','0571-12345678','08:00-22:00',120.1234567,30.2876543,1,0,'2026-05-04 16:03:16','2026-05-04 16:03:16'),(2,'滨江分点','杭州市滨江区江南大道 88 号','0571-87654321','09:00-21:00',120.2098765,30.2056789,1,0,'2026-05-04 16:03:16','2026-05-04 16:03:16'),(3,'杭州大悦城店','浙江省杭州市拱墅区祥符街道松鼠仔少儿运动成长中心(轮滑·跑酷·体适能)杭州大悦城','1234678','08:00-22:00',120.1296010,30.3006830,1,0,'2026-05-08 12:41:35','2026-05-08 12:41:35');
...
CREATE TABLE `product` (
  ...
  `status` tinyint NOT NULL DEFAULT '1' COMMENT '0已下架 1在售 2回收站 3草稿',
...
INSERT INTO `product` VALUES (1,'阳光玫瑰葡萄','当日新摘 现剪现发',101,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/grape.jpg',NULL,'&lt;h3&gt;阳光玫瑰葡萄&lt;/h3&gt;&lt;p&gt;当日新摘，现剪现发，颗颗饱满多汁，甜度高达20+，清脆爽口无籽体验。&lt;/p&gt;&lt;ul&gt;&lt;li&gt;产地：云南宾川&lt;/li&gt;&lt;li&gt;规格：500g/串&lt;/li&gt;&lt;li&gt;储存：冷藏0-4℃&lt;/li&gt;&lt;/ul&gt;',29.90,89.00,200,350,1,1,1,2,5,0,'2026-05-04 16:03:16','2026-05-09 12:38:09'),(2,'智利进口车厘子 JJJ级','空运直达 颗颗甜爽',201,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/cherry.jpg',NULL,'<h3>智利进口车厘子 JJJ级</h3><p>空运直达，颗颗甜爽，果径30mm+，深红饱满，送礼自用皆宜。</p><ul><li>产地：智利</li><li>规格：500g/盒</li><li>储存：冷藏0-4℃</li></ul>',168.00,288.00,80,120,1,1,1,1,5,0,'2026-05-04 16:03:16','2026-05-09 11:03:50'),(3,'丹东99草莓','现摘现发 颗颗饱满',101,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/strawberry.jpg',NULL,'<h3>丹东99草莓</h3><p>现摘现发，颗颗饱满，奶香浓郁，甜酸适口，红颜品种。</p><ul><li>产地：辽宁丹东</li><li>规格：300g/盒</li><li>储存：冷藏0-4℃即食</li></ul>',39.90,59.00,150,220,1,1,1,1,5,0,'2026-05-04 16:03:16','2026-05-09 11:03:50'),(4,'海南金煌芒果','树上自然熟 甜过初恋',102,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/mango.jpg',NULL,'<h3>海南金煌芒果</h3><p>树上自然熟，甜过初恋，果肉厚实细腻，纤维少，香气浓郁。</p><ul><li>产地：海南三亚</li><li>规格：5斤装</li><li>储存：常温催熟后冷藏</li></ul>',19.90,49.00,299,1200,1,1,1,1,5,0,'2026-05-04 16:03:16','2026-05-09 11:03:50'),(5,'赣南脐橙','皮薄多汁 橙香浓郁',401,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/orange.jpg',NULL,'<h3>赣南脐橙</h3><p>皮薄多汁，橙香浓郁，自然成熟采摘，维C满满。</p><ul><li>产地：江西赣南</li><li>规格：10斤装</li><li>储存：阴凉通风处</li></ul>',12.80,22.80,230,300,1,1,1,1,5,0,'2026-05-04 16:03:16','2026-05-09 12:03:37'),(6,'新鲜红富士苹果','口感清甜 脆爽多汁',402,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/apple.jpg',NULL,'<h3>新鲜红富士苹果</h3><p>脆甜多汁，果香浓郁，烟台产地直发，自然成熟。</p><ul><li>产地：山东烟台</li><li>规格：5斤装</li><li>储存：阴凉通风或冷藏</li></ul>',12.80,22.80,250,500,0,1,1,1,5,0,'2026-05-04 16:03:16','2026-05-09 12:03:37'),(7,'精品水果礼盒','6种鲜果 精美包装',301,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/giftbox.jpg',NULL,'<h3>精品水果礼盒</h3><p>精选时令鲜果，精美礼盒包装，节日送礼首选。</p><ul><li>产地：多产地精选</li><li>规格：大礼盒约5kg</li><li>储存：请尽快食用</li></ul>',128.00,268.00,30,45,0,1,1,1,5,0,'2026-05-04 16:03:16','2026-05-09 12:03:37'),(8,'小蜜蜂蓝莓','颗粒饱满 花香浓郁',201,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/blueberry.jpg',NULL,'<h3>小蜜蜂蓝莓</h3><p>颗粒饱满，花青素丰富，酸甜适口，鲜食佳品。</p><ul><li>产地：云南曲靖</li><li>规格：125g/盒</li><li>储存：冷藏0-4℃</li></ul>',29.90,59.00,100,180,0,1,1,1,5,0,'2026-05-04 16:03:16','2026-05-09 12:03:37'),(9,'水蜜桃','果肉细腻 汁多味甜',102,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/peach.jpg',NULL,'<h3>水蜜桃</h3><p>皮薄肉厚，汁多味甜，入口即化，夏日鲜果。</p><ul><li>产地：江苏无锡</li><li>规格：4个装</li><li>储存：常温即食，冷藏保鲜</li></ul>',25.00,45.00,130,260,0,1,1,1,5,0,'2026-05-04 16:03:16','2026-05-09 12:03:37'),(10,'黑美人西瓜','沙瓤清甜 消暑首选',402,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/watermelon.jpg',NULL,'<h3>黑美人西瓜</h3><p>皮薄瓤红，甜度爆表，清凉解暑，一人食刚好。</p><ul><li>产地：海南</li><li>规格：约3kg/个</li><li>储存：阴凉处，切后冷藏</li></ul>',15.00,35.00,90,420,0,1,1,1,5,0,'2026-05-04 16:03:16','2026-05-09 12:03:37'),(11,'云南蓝莓大果','颗粒饱满 花香浓郁',201,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/blueberry.jpg',NULL,'<h3>云南蓝莓大果</h3><p>大果蓝莓，颗粒饱满，花青素丰富，鲜食烘焙皆宜。</p><ul><li>产地：云南曲靖</li><li>规格：250g/盒</li><li>储存：冷藏0-4℃</li></ul>',29.90,59.00,0,180,1,1,1,1,5,0,'2026-05-04 16:03:16','2026-05-09 12:03:37'),(12,'泰国山竹','果后驾到 细腻清甜',202,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/mangosteen.jpg',NULL,'<h3>泰国山竹</h3><p>果后之称，蒜瓣白嫩，清甜细腻，营养滋补。</p><ul><li>产地：泰国</li><li>规格：500g/份</li><li>储存：冷藏5-8℃</li></ul>',45.00,79.00,60,90,0,1,1,0,5,0,'2026-05-04 16:03:16','2026-05-09 12:03:37'),(13,'新西兰奇异果','维C之王 酸甜可口',201,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/kiwi.jpg',NULL,'<h3>新西兰奇异果</h3><p>阳光金果，维C之王，酸甜爽口，营养满分。</p><ul><li>产地：新西兰</li><li>规格：6个装</li><li>储存：常温催熟后冷藏</li></ul>',19.90,39.90,120,260,1,1,0,1,5,0,'2026-05-04 16:03:16','2026-05-09 12:03:37'),(14,'芒果班戟','现做现发 绵密奶油',602,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/crepe.jpg',NULL,'<h3>芒果班戟</h3><p>手工现做，新鲜芒果搭配奶油，皮薄馅多，甜而不腻。</p><ul><li>产地：本地现做</li><li>规格：4个装</li><li>储存：冷藏即食，当日最佳</li></ul>',38.00,38.00,15,320,1,0,1,1,5,0,'2026-05-04 16:03:16','2026-05-09 12:03:37'),(15,'有机小番茄','农场直供 鲜嫩多汁',701,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/tomato.jpg',NULL,'<h3>有机小番茄</h3><p>自然成熟，皮薄汁多，甜度高，可当水果吃的小番茄。</p><ul><li>产地：山东寿光</li><li>规格：500g/盒</li><li>储存：冷藏0-4℃</li></ul>',18.80,18.80,120,640,1,1,1,1,5,0,'2026-05-04 16:03:16','2026-05-09 12:03:37'),(16,'有机胡萝卜','甜脆爽口 营养丰富',702,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/carrot.jpg',NULL,'<h3>有机胡萝卜</h3><p>有机种植，口感脆甜，胡萝卜素丰富，榨汁炒菜皆宜。</p><ul><li>产地：河北张家口</li><li>规格：2斤装</li><li>储存：阴凉通风或冷藏</li></ul>',12.50,12.50,90,280,0,1,1,1,5,0,'2026-05-04 16:03:16','2026-05-09 12:03:37'),(17,'农家土鸡蛋 30枚','散养走地鸡 蛋黄饱满',801,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/egg.jpg',NULL,'<h3>农家土鸡蛋 30枚</h3><p>散养土鸡所产，蛋黄色深，营养丰富，煎煮炖皆宜。</p><ul><li>产地：本地农家</li><li>规格：30枚/盒</li><li>储存：冷藏4℃以下</li></ul>',32.00,32.00,60,1500,1,1,1,1,5,0,'2026-05-04 16:03:16','2026-05-09 12:03:37'),(18,'鲜活大闸蟹 4两公','阳澄湖直发 鲜活到家',802,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/crab.jpg',NULL,'<h3>鲜活大闸蟹 4两公</h3><p>阳澄湖产区，膏肥黄满，鲜活直达，秋季美味。</p><ul><li>产地：阳澄湖</li><li>规格：4两公蟹4只</li><li>储存：冰箱冷藏保湿，尽快食用</li></ul>',88.00,128.00,0,420,0,1,1,1,5,0,'2026-05-04 16:03:16','2026-05-09 12:03:37'),(19,'榴莲千层蛋糕','浓郁香软 限量供应',602,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/duriancake.jpg',NULL,'<h3>榴莲千层蛋糕</h3><p>猫山王榴莲果肉，手工千层，层层浓郁，榴莲控必试。</p><ul><li>产地：本地现做</li><li>规格：6寸整只</li><li>储存：冷藏即食，2日内最佳</li></ul>',68.00,68.00,3,150,1,1,1,1,5,0,'2026-05-04 16:03:16','2026-05-09 12:03:37'),(20,'每日坚果混合装 30包','7种坚果 营养均衡',502,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/nuts.jpg',NULL,'<h3>每日坚果混合装 30包</h3><p>6种坚果果干搭配，每日一包，营养均衡，办公零食首选。</p><ul><li>产地：多产地精选</li><li>规格：30包/盒 每包25g</li><li>储存：阴凉干燥处</li></ul>',59.90,89.90,499,4600,1,1,1,1,5,0,'2026-05-04 16:03:16','2026-05-09 12:03:37'),(21,'芒果干大袋装','自然风干 酸甜可口',501,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/mangodry.jpg',NULL,'<h3>芒果干大袋装</h3><p>泰国芒果低温烘干，酸甜软糯，无添加防腐剂，解馋零嘴。</p><ul><li>产地：泰国</li><li>规格：200g/袋</li><li>储存：阴凉干燥处，开封后密封</li></ul>',15.90,15.90,400,2100,0,1,1,1,5,0,'2026-05-04 16:03:16','2026-05-09 12:03:37'),(22,'NFC鲜榨橙汁 1L','0添加 原汁原味',601,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/orangejuice.jpg',NULL,'<h3>NFC鲜榨橙汁 1L</h3><p>非浓缩还原，鲜榨工艺，保留原果风味，无添加糖。</p><ul><li>产地：江西赣南</li><li>规格：1L/瓶</li><li>储存：冷藏0-4℃，开封后尽快饮用</li></ul>',22.90,22.90,200,980,0,1,1,1,5,0,'2026-05-04 16:03:16','2026-05-09 12:03:37');
...
) ENGINE=InnoDB AUTO_INCREMENT=136 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='商品图片';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `product_image` VALUES (5,2,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/cherry.jpg',1,1),(6,2,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/cherry-2.jpg',1,2),(7,3,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/strawberry.jpg',1,1),(8,3,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/strawberry-2.jpg',1,2),(9,4,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/mango.jpg',1,1),(10,5,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/orange.jpg',1,1),(11,6,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/apple.jpg',1,1),(12,7,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/giftbox.jpg',1,1),(13,8,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/blueberry.jpg',1,1),(14,9,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/peach.jpg',1,1),(15,10,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/watermelon.jpg',1,1),(16,11,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/blueberry.jpg',1,1),(17,12,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/mangosteen.jpg',1,1),(18,13,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/kiwi.jpg',1,1),(19,13,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/kiwi-2.jpg',1,2),(20,14,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/crepe.jpg',1,1),(21,15,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/tomato.jpg',1,1),(22,16,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/carrot.jpg',1,1),(23,17,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/egg.jpg',1,1),(24,18,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/crab.jpg',1,1),(25,19,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/duriancake.jpg',1,1),(26,20,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/nuts.jpg',1,1),(27,21,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/mangodry.jpg',1,1),(28,22,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/orangejuice.jpg',1,1),(59,24,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/admin/2026/05/05/8522adea6d9c4e6493f372e5cabab6c0.jpg',1,0),(60,24,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/admin/2026/05/07/8a532c3250674817ab4b622a1bd9153f.jpg',1,1),(61,24,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/admin/2026/05/05/b80932ee156c4f75b5ea4b188f161458.jpg',2,2),(64,2,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/cherry-2.jpg',2,1),(65,3,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/strawberry-2.jpg',2,1),(66,4,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/mango.jpg',1,1),(67,4,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/crepe.jpg',1,2),(68,4,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/mango.jpg',2,1),(69,5,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/orange.jpg',1,1),(70,5,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/orangejuice.jpg',1,2),(71,5,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/orange.jpg',2,1),(72,6,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/apple.jpg',1,1),(73,6,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/apple.jpg',2,1),(74,7,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/giftbox.jpg',1,1),(75,7,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/giftbox.jpg',2,1),(76,8,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/blueberry.jpg',1,1),(77,8,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/blueberry.jpg',2,1),(78,9,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/peach.jpg',1,1),(79,9,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/peach.jpg',2,1),(80,10,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/watermelon.jpg',1,1),(81,10,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/watermelon.jpg',2,1),(82,11,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/blueberry.jpg',1,1),(83,11,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/blueberry.jpg',2,1),(84,12,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/mangosteen.jpg',1,1),(85,12,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/mangosteen.jpg',2,1),(86,13,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/kiwi-2.jpg',2,1),(87,14,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/crepe.jpg',1,1),(88,14,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/crepe.jpg',2,1),(89,15,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/tomato.jpg',1,1),(90,15,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/tomato.jpg',2,1),(91,16,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/carrot.jpg',1,1),(92,16,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/carrot.jpg',2,1),(93,17,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/egg.jpg',1,1),(94,17,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/egg.jpg',2,1),(95,18,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/crab.jpg',1,1),(96,18,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/crab.jpg',2,1),(97,19,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/duriancake.jpg',1,1),(98,19,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/duriancake.jpg',2,1),(99,20,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/nuts.jpg',1,1),(100,20,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/mangodry.jpg',1,2),(101,20,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/nuts.jpg',2,1),(102,21,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/mangodry.jpg',1,1),(103,21,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/mangodry.jpg',2,1),(104,22,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/orangejuice.jpg',1,1),(105,22,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/orangejuice.jpg',2,1),(130,1,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/grape.jpg',1,0),(131,1,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/grape-2.jpg',1,1),(132,1,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/grape-3.jpg',1,2),(133,1,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/grape-2.jpg',2,3),(134,1,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/grape-3.jpg',2,4),(135,1,'https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/product/grape-d1.jpg',2,5);
...
CREATE TABLE `product_sku` (
  ...
  KEY `idx_product_id` (`product_id`)
) ENGINE=InnoDB AUTO_INCREMENT=74 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='商品规格 SKU';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `refund` (
  ...
  `refund_channel` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '退款通道 MOCK/wechat/alipay',
...
INSERT INTO `refund` VALUES (1,'RF20260427001',8,1,1,64.00,'水果有损坏，不新鲜','[\"https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/refund/damage1.jpg\", \"https://ojc-xianguoji.oss-cn-beijing.aliyuncs.com/seed/refund/damage2.jpg\"]',0,NULL,NULL,NULL,NULL,NULL,'2026-04-27 16:00:00','2026-05-04 16:03:17',NULL,NULL),(2,'RF20260426002',9,1,1,34.90,'商品与描述不符','[]',3,'MOCK','MOCK_REFUND_RF20260426002',NULL,1,'2026-04-26 16:00:00','2026-04-26 14:00:00','2026-05-19 16:50:22',NULL,NULL);
...
CREATE TABLE `search_history` (
  ...
  KEY `idx_user_id` (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='搜索历史';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `search_history` VALUES (2,3,'车厘子','2026-05-08 13:50:58'),(3,3,'草莓','2026-05-08 13:51:14');
...
INSERT INTO `staff` VALUES (1,'admin','$2a$10$KpPaFulLg8yofI8w2Lah5euKVcYxuTDHQY0VyEvJ3kahZon1uIBCi','张老板','13800000000',NULL,'owner',NULL,1,'2026-05-09 10:04:49','2026-05-04 16:03:16','2026-05-04 16:03:16',NULL),(2,'packer','$2b$10$.Xv/qEaxR5uW/.xIgcvbw.z3uf/0m78Lvq3Pk/cJi7T6QE7mjemo6','小王','13800000001',NULL,'packer',NULL,1,NULL,'2026-05-04 16:03:16','2026-05-04 16:03:16',NULL);
...
-- Dump completed on 2026-05-19 16:52:12
